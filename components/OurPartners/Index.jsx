  ...
  return (
    <div className="flex flex-row"> 
      <div className=" w-1/12  ml-6">
        ...
        <div className="  mt-72"> <Image src={atom} alt="atom"  height={50} width={50}  /></div></div>
     <div className="flex flex-col  w-10/12">
       <div  className="flex   flex-wrap  ">
           {partners.map((partner, index) => (
           <div className={`flex flex-col relative ${partner.space ? " lg:mx-96   " : " mx-auto  "}   mx-auto my-10  `}>
              <div className={` bg-${partner.color}  backdrop:blur blur-sm w-72  md:w-96`}>
               <p className=" text-center  " >{partner.text}</p></div>
               <Image src={partner.src}  className=" "   />
            </div>
           
            ))}
         </div>
        <div className=" md:ml-32  md:-mt-40  opacity-50"><Image src={computer}   height={50} width={50} /></div>
     </div>
