...
const TheyTrustedUs = () => {
    ...
    <div className="relative">
            ...
            <div className="flex flex-col gap-9 w-2/3 2xl:ml-52 lg:ml-40 lg:flex-row lg:mt-20 lg:gap-28 w-3/4 mx-auto  2xl:flex-row 2xl:mt-32 2xl:gap-40 w-3/4 mx-auto">
                
                <div classsName="mt-8 h-16 w-44 lg:w-[22rem] lg:h-36 2xl:h-44 2xl:w-[33rem]">
                    <Image src={qBraid} alt="qbraid logo" /></div>
                
                <div className="lg:mt-10">
                    <div classsName="h-16 w-36 lg:w-[22rem] lg:h-36 2xl:h-52 2xl:w-[33rem]">
